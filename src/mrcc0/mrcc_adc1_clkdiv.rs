#[doc = "Register `MRCC_ADC1_CLKDIV` reader"]
pub type R = crate::R<MrccAdc1ClkdivSpec>;
#[doc = "Register `MRCC_ADC1_CLKDIV` writer"]
pub type W = crate::W<MrccAdc1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, MrccAdc1ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, MrccAdc1ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, MrccAdc1ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "ADC1 clock divider control\n\nYou can [`read`](crate::Reg::read) this register and get [`mrcc_adc1_clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mrcc_adc1_clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MrccAdc1ClkdivSpec;
impl crate::RegisterSpec for MrccAdc1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_adc1_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccAdc1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_adc1_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccAdc1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_ADC1_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccAdc1ClkdivSpec {
