...
#[doc = "Field `TRIMTEMP2` reader - Trim Temperature2"]
pub type Trimtemp2R = crate::FieldReader;
#[doc = "Field `TRIMTEMP2` writer - Trim Temperature2"]
pub type Trimtemp2W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    #[doc = "Bits 18:19 - Trim Temperature2"]
    #[inline(always)]
    pub fn trimtemp2(&self) -> Trimtemp2R {
        Trimtemp2R::new(((self.bits >> 18) & 3) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 18:19 - Trim Temperature2"]
    #[inline(always)]
    pub fn trimtemp2(&mut self) -> Trimtemp2W<'_, FirctrimSpec> {
        Trimtemp2W::new(self, 18)
    }
    #[doc = "Bits 24:29 - Trim Start"]
    #[inline(always)]
