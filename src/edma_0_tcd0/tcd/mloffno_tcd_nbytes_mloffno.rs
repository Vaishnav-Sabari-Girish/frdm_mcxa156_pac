...
impl W {
    #[doc = "Bits 0:29 - Number of Bytes To Transfer Per Service Request"]
    #[inline(always)]
    pub fn nbytes(&mut self) -> NbytesW<'_, MloffnoTcdNbytesMloffnoSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn dmloe(&mut self) -> DmloeW<'_, MloffnoTcdNbytesMloffnoSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn smloe(&mut self) -> SmloeW<'_, MloffnoTcdNbytesMloffnoSpec> {
        SmloeW::new(self, 31)
    }
}
