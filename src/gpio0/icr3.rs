...
pub type R = crate::R<Icr3Spec>;
#[doc = "Register `ICR3` writer"]
pub type W = crate::W<Icr3Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr3Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr3Spec> {
        IsfW::new(self, 24)
    }
}
