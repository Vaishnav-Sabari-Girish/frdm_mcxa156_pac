...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_39(&mut self) -> DataByte39W<'_, Mb64bGroupMb5_64bWord9Spec> {
        DataByte39W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_38(&mut self) -> DataByte38W<'_, Mb64bGroupMb5_64bWord9Spec> {
        DataByte38W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_37(&mut self) -> DataByte37W<'_, Mb64bGroupMb5_64bWord9Spec> {
        DataByte37W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_36(&mut self) -> DataByte36W<'_, Mb64bGroupMb5_64bWord9Spec> {
