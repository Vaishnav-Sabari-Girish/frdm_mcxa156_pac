...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_27(&mut self) -> DataByte27W<'_, Mb32bGroupMb5_32bWord6Spec> {
        DataByte27W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_26(&mut self) -> DataByte26W<'_, Mb32bGroupMb5_32bWord6Spec> {
        DataByte26W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_25(&mut self) -> DataByte25W<'_, Mb32bGroupMb5_32bWord6Spec> {
        DataByte25W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_24(&mut self) -> DataByte24W<'_, Mb32bGroupMb5_32bWord6Spec> {
