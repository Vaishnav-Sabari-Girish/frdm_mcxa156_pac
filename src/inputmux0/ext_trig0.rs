#[doc = "Register `EXT_TRIG0` reader"]
pub type R = crate::R<ExtTrig0Spec>;
#[doc = "Register `EXT_TRIG0` writer"]
pub type W = crate::W<ExtTrig0Spec>;
...
pub enum Inp {
    ...
    Val7 = 7,
    #[doc = "9: LPUART0 input is selected"]
    Val9 = 9,
    #[doc = "10: LPUART1 input is selected"]
    Val10 = 10,
    #[doc = "11: LPUART2 input is selected"]
    Val11 = 11,
    #[doc = "12: LPUART3 input is selected"]
    Val12 = 12,
    #[doc = "13: LPUART4 input is selected"]
    Val13 = 13,
    ...
    Val16 = 16,
    #[doc = "17: AOI1_OUT3 input is selected"]
    Val17 = 17,
}
...
impl W {
    #[doc = "Bits 0:4 - EXT trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<'_, ExtTrig0Spec> {
        InpW::new(self, 0)
    }
}
#[doc = "EXT trigger connections 0\n\nYou can [`read`](crate::Reg::read) this register and get [`ext_trig0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ext_trig0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ExtTrig0Spec;
impl crate::RegisterSpec for ExtTrig0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ext_trig0::R`](R) reader structure"]
impl crate::Readable for ExtTrig0Spec {}
#[doc = "`write(|w| ..)` method takes [`ext_trig0::W`](W) writer structure"]
impl crate::Writable for ExtTrig0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EXT_TRIG0 to value 0x1f"]
impl crate::Resettable for ExtTrig0Spec {
