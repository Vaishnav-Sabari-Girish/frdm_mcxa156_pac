#[doc = "Register `ICR8` reader"]
pub type R = crate::R<Icr8Spec>;
#[doc = "Register `ICR8` writer"]
pub type W = crate::W<Icr8Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr8Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr8Spec> {
        IsfW::new(self, 24)
    }
}
#[doc = "Interrupt Control 8\n\nYou can [`read`](crate::Reg::read) this register and get [`icr8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Icr8Spec;
impl crate::RegisterSpec for Icr8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icr8::R`](R) reader structure"]
impl crate::Readable for Icr8Spec {}
#[doc = "`write(|w| ..)` method takes [`icr8::W`](W) writer structure"]
impl crate::Writable for Icr8Spec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0100_0000;
}
#[doc = "`reset()` method sets ICR8 to value 0"]
impl crate::Resettable for Icr8Spec {}
