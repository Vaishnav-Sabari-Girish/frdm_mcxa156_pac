...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_19(&mut self) -> DataByte19W<'_, Mb32bGroupMb11_32bWord4Spec> {
        DataByte19W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_18(&mut self) -> DataByte18W<'_, Mb32bGroupMb11_32bWord4Spec> {
        DataByte18W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_17(&mut self) -> DataByte17W<'_, Mb32bGroupMb11_32bWord4Spec> {
        DataByte17W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_16(&mut self) -> DataByte16W<'_, Mb32bGroupMb11_32bWord4Spec> {
