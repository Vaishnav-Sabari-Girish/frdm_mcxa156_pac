#[doc = "Register `ICR16` reader"]
pub type R = crate::R<Icr16Spec>;
#[doc = "Register `ICR16` writer"]
pub type W = crate::W<Icr16Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr16Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr16Spec> {
        IsfW::new(self, 24)
    }
}
#[doc = "Interrupt Control 16\n\nYou can [`read`](crate::Reg::read) this register and get [`icr16::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr16::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Icr16Spec;
impl crate::RegisterSpec for Icr16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icr16::R`](R) reader structure"]
impl crate::Readable for Icr16Spec {}
#[doc = "`write(|w| ..)` method takes [`icr16::W`](W) writer structure"]
impl crate::Writable for Icr16Spec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0100_0000;
}
#[doc = "`reset()` method sets ICR16 to value 0"]
impl crate::Resettable for Icr16Spec {}
