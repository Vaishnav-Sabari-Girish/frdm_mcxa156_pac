...
impl W {
    #[doc = "Bit 0 - Pull Select"]
    #[inline(always)]
    pub fn ps(&mut self) -> PsW<'_, Pcr29Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<'_, Pcr29Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Pull Value"]
    #[inline(always)]
    pub fn pv(&mut self) -> PvW<'_, Pcr29Spec> {
        PvW::new(self, 2)
    }
    #[doc = "Bit 3 - Slew Rate Enable"]
    #[inline(always)]
    pub fn sre(&mut self) -> SreW<'_, Pcr29Spec> {
        SreW::new(self, 3)
    }
    #[doc = "Bit 4 - Passive Filter Enable"]
    #[inline(always)]
    pub fn pfe(&mut self) -> PfeW<'_, Pcr29Spec> {
        PfeW::new(self, 4)
    }
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<'_, Pcr29Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse(&mut self) -> DseW<'_, Pcr29Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Pin Multiplex Control"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<'_, Pcr29Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<'_, Pcr29Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, Pcr29Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<'_, Pcr29Spec> {
        LkW::new(self, 15)
    }
}
