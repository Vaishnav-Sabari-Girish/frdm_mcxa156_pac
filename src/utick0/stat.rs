...
pub type ActiveW<'a, REG> = crate::BitWriter1C<'a, REG, Active>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Inactive (stopped)"]
    #[inline(always)]
    pub fn timerisnotactive(self) -> &'a mut crate::W<REG> {
        self.variant(Active::Timerisnotactive)
    }
    #[doc = "Active"]
    #[inline(always)]
    pub fn timerisactive(self) -> &'a mut crate::W<REG> {
        self.variant(Active::Timerisactive)
    }
}
impl R {
