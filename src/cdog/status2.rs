...
#[doc = "Field `NUMCNTF` reader - Number of CONTROL faults since the last POR"]
pub type NumcntfR = crate::FieldReader;
#[doc = "Field `NUMILLSTF` reader - Number of STATE faults since the last POR"]
pub type NumillstfR = crate::FieldReader;
#[doc = "Field `NUMILLA` reader - Number of ADDRESS faults since the last POR"]
pub type NumillaR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Number of CONTROL faults since the last POR"]
    #[inline(always)]
    pub fn numcntf(&self) -> NumcntfR {
        NumcntfR::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Number of STATE faults since the last POR"]
    #[inline(always)]
    pub fn numillstf(&self) -> NumillstfR {
        NumillstfR::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Number of ADDRESS faults since the last POR"]
    #[inline(always)]
