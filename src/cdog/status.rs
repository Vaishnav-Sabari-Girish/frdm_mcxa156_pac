...
#[doc = "Field `NUMTOF` reader - Number of TIMEOUT faults since the last POR"]
pub type NumtofR = crate::FieldReader;
#[doc = "Field `NUMMISCOMPF` reader - Number of MISCOMPARE faults since the last POR"]
pub type NummiscompfR = crate::FieldReader;
#[doc = "Field `NUMILSEQF` reader - Number of SEQUENCE faults since the last POR"]
pub type NumilseqfR = crate::FieldReader;
#[doc = "Field `CURST` reader - Current State"]
pub type CurstR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Number of TIMEOUT faults since the last POR"]
    #[inline(always)]
    pub fn numtof(&self) -> NumtofR {
        NumtofR::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Number of MISCOMPARE faults since the last POR"]
    #[inline(always)]
    pub fn nummiscompf(&self) -> NummiscompfR {
        NummiscompfR::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Number of SEQUENCE faults since the last POR"]
    #[inline(always)]
