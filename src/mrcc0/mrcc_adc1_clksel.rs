#[doc = "Register `MRCC_ADC1_CLKSEL` reader"]
pub type R = crate::R<MrccAdc1ClkselSpec>;
#[doc = "Register `MRCC_ADC1_CLKSEL` writer"]
pub type W = crate::W<MrccAdc1ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<'_, MrccAdc1ClkselSpec> {
        MuxW::new(self, 0)
    }
}
#[doc = "ADC1 clock selection control\n\nYou can [`read`](crate::Reg::read) this register and get [`mrcc_adc1_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mrcc_adc1_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MrccAdc1ClkselSpec;
impl crate::RegisterSpec for MrccAdc1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_adc1_clksel::R`](R) reader structure"]
impl crate::Readable for MrccAdc1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_adc1_clksel::W`](W) writer structure"]
impl crate::Writable for MrccAdc1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_ADC1_CLKSEL to value 0x07"]
impl crate::Resettable for MrccAdc1ClkselSpec {
