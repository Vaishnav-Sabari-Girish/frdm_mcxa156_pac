#[doc = "Register `ICR11` reader"]
pub type R = crate::R<Icr11Spec>;
#[doc = "Register `ICR11` writer"]
pub type W = crate::W<Icr11Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr11Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr11Spec> {
        IsfW::new(self, 24)
    }
}
#[doc = "Interrupt Control 11\n\nYou can [`read`](crate::Reg::read) this register and get [`icr11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Icr11Spec;
impl crate::RegisterSpec for Icr11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icr11::R`](R) reader structure"]
impl crate::Readable for Icr11Spec {}
#[doc = "`write(|w| ..)` method takes [`icr11::W`](W) writer structure"]
impl crate::Writable for Icr11Spec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0100_0000;
}
#[doc = "`reset()` method sets ICR11 to value 0"]
impl crate::Resettable for Icr11Spec {}
