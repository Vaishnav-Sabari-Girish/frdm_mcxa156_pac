...
pub type R = crate::R<Icr4Spec>;
#[doc = "Register `ICR4` writer"]
pub type W = crate::W<Icr4Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr4Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr4Spec> {
        IsfW::new(self, 24)
    }
}
