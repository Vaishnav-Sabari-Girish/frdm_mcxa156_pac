...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_11(&mut self) -> DataByte11W<'_, Mb64bGroupMb4_64bWord2Spec> {
        DataByte11W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_10(&mut self) -> DataByte10W<'_, Mb64bGroupMb4_64bWord2Spec> {
        DataByte10W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_9(&mut self) -> DataByte9W<'_, Mb64bGroupMb4_64bWord2Spec> {
        DataByte9W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_8(&mut self) -> DataByte8W<'_, Mb64bGroupMb4_64bWord2Spec> {
