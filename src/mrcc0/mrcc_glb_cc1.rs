...
impl W {
    ...
    #[doc = "Bit 18 - RAMA"]
    #[inline(always)]
    pub fn rama(&mut self) -> RamaW<'_, MrccGlbCc1Spec> {
        RamaW::new(self, 18)
    }
    #[doc = "Bit 19 - RAMB"]
    #[inline(always)]
    pub fn ramb(&mut self) -> RambW<'_, MrccGlbCc1Spec> {
        RambW::new(self, 19)
    }
    #[doc = "Bit 20 - GPIO0"]
    #[inline(always)]
    pub fn gpio0(&mut self) -> Gpio0W<'_, MrccGlbCc1Spec> {
        Gpio0W::new(self, 20)
    }
    #[doc = "Bit 21 - GPIO1"]
    #[inline(always)]
    pub fn gpio1(&mut self) -> Gpio1W<'_, MrccGlbCc1Spec> {
        Gpio1W::new(self, 21)
    }
    #[doc = "Bit 22 - GPIO2"]
    #[inline(always)]
    pub fn gpio2(&mut self) -> Gpio2W<'_, MrccGlbCc1Spec> {
        Gpio2W::new(self, 22)
    }
    #[doc = "Bit 23 - GPIO3"]
    #[inline(always)]
    pub fn gpio3(&mut self) -> Gpio3W<'_, MrccGlbCc1Spec> {
        Gpio3W::new(self, 23)
    }
    #[doc = "Bit 24 - GPIO4"]
    #[inline(always)]
    pub fn gpio4(&mut self) -> Gpio4W<'_, MrccGlbCc1Spec> {
        Gpio4W::new(self, 24)
    }
    #[doc = "Bit 25 - ROMC"]
    #[inline(always)]
    pub fn romc(&mut self) -> RomcW<'_, MrccGlbCc1Spec> {
        RomcW::new(self, 25)
    }
}
