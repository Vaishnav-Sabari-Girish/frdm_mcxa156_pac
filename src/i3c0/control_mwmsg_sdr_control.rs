...
impl W {
    #[doc = "Bit 0 - Direction"]
    #[inline(always)]
    pub fn dir(&mut self) -> DirW<'_, ControlMwmsgSdrControlSpec> {
        DirW::new(self, 0)
    }
    #[doc = "Bits 1:7 - Address"]
    #[inline(always)]
    pub fn addr(&mut self) -> AddrW<'_, ControlMwmsgSdrControlSpec> {
        AddrW::new(self, 1)
    }
    #[doc = "Bit 8 - End of SDR Message"]
    #[inline(always)]
    pub fn end(&mut self) -> EndW<'_, ControlMwmsgSdrControlSpec> {
        EndW::new(self, 8)
    }
    #[doc = "Bit 10 - I2C"]
    #[inline(always)]
    pub fn i2c(&mut self) -> I2cW<'_, ControlMwmsgSdrControlSpec> {
        I2cW::new(self, 10)
    }
    #[doc = "Bits 11:15 - Length"]
    #[inline(always)]
    pub fn len(&mut self) -> LenW<'_, ControlMwmsgSdrControlSpec> {
        LenW::new(self, 11)
    }
}
