...
#[doc = "Field `TXCOUNT` reader - Transmit Byte Count"]
pub type TxcountR = crate::FieldReader;
#[doc = "Field `RXCOUNT` reader - Receive Byte Count"]
...
impl R {
    ...
    #[doc = "Bits 16:20 - Transmit Byte Count"]
    #[inline(always)]
    pub fn txcount(&self) -> TxcountR {
        TxcountR::new(((self.bits >> 16) & 0x1f) as u8)
    }
    #[doc = "Bits 24:28 - Receive Byte Count"]
    #[inline(always)]
