...
pub type MaskxW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `MASKB` reader - PWM_B Masks"]
pub type MaskbR = crate::FieldReader;
#[doc = "Field `MASKB` writer - PWM_B Masks"]
pub type MaskbW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `MASKA` reader - PWM_A Masks"]
pub type MaskaR = crate::FieldReader;
#[doc = "Field `MASKA` writer - PWM_A Masks"]
pub type MaskaW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `UPDATE_MASK` writer - Update Mask Bits Immediately"]
pub type UpdateMaskW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - PWM_X Masks"]
    #[inline(always)]
    pub fn maskx(&self) -> MaskxR {
        MaskxR::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - PWM_B Masks"]
    #[inline(always)]
    pub fn maskb(&self) -> MaskbR {
        MaskbR::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bits 8:10 - PWM_A Masks"]
    #[inline(always)]
    pub fn maska(&self) -> MaskaR {
        MaskaR::new(((self.bits >> 8) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - PWM_X Masks"]
    ...
    #[doc = "Bits 12:14 - Update Mask Bits Immediately"]
    #[inline(always)]
