...
impl R {
    ...
    pub fn dma(&self) -> DmaR {
        DmaR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - AOI0"]
    #[inline(always)]
    pub fn aoi0(&self) -> Aoi0R {
        Aoi0R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - CRC0"]
    #[inline(always)]
    pub fn crc0(&self) -> Crc0R {
        Crc0R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - EIM0"]
    #[inline(always)]
    pub fn eim0(&self) -> Eim0R {
        Eim0R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - ERM0"]
    #[inline(always)]
    pub fn erm0(&self) -> Erm0R {
        Erm0R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - FMC"]
    #[inline(always)]
    pub fn fmc(&self) -> FmcR {
        FmcR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - AOI1"]
    #[inline(always)]
    pub fn aoi1(&self) -> Aoi1R {
        Aoi1R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - FLEXIO0"]
    #[inline(always)]
    pub fn flexio0(&self) -> Flexio0R {
        Flexio0R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - LPI2C0"]
    #[inline(always)]
    pub fn lpi2c0(&self) -> Lpi2c0R {
        Lpi2c0R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - LPI2C1"]
    #[inline(always)]
    pub fn lpi2c1(&self) -> Lpi2c1R {
        Lpi2c1R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - LPSPI0"]
    #[inline(always)]
    pub fn lpspi0(&self) -> Lpspi0R {
        Lpspi0R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - LPSPI1"]
    #[inline(always)]
    pub fn lpspi1(&self) -> Lpspi1R {
        Lpspi1R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - LPUART0"]
    #[inline(always)]
    pub fn lpuart0(&self) -> Lpuart0R {
        Lpuart0R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - LPUART1"]
    #[inline(always)]
    pub fn lpuart1(&self) -> Lpuart1R {
        Lpuart1R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - LPUART2"]
    #[inline(always)]
    pub fn lpuart2(&self) -> Lpuart2R {
        Lpuart2R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - LPUART3"]
    #[inline(always)]
    pub fn lpuart3(&self) -> Lpuart3R {
        Lpuart3R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - LPUART4"]
    #[inline(always)]
    pub fn lpuart4(&self) -> Lpuart4R {
        Lpuart4R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - USB0"]
    #[inline(always)]
    pub fn usb0(&self) -> Usb0R {
        Usb0R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - QDC0"]
    #[inline(always)]
    pub fn qdc0(&self) -> Qdc0R {
        Qdc0R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - QDC1"]
    #[inline(always)]
    pub fn qdc1(&self) -> Qdc1R {
        Qdc1R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - FLEXPWM0"]
    #[inline(always)]
    pub fn flexpwm0(&self) -> Flexpwm0R {
        Flexpwm0R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - FLEXPWM1"]
    #[inline(always)]
    pub fn flexpwm1(&self) -> Flexpwm1R {
        Flexpwm1R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - INPUTMUX0"]
    ...
    #[doc = "Bit 10 - DMA"]
    #[inline(always)]
    pub fn dma(&mut self) -> DmaW<'_, MrccGlbAcc0Spec> {
        DmaW::new(self, 10)
    }
    #[doc = "Bit 11 - AOI0"]
    #[inline(always)]
    ...
    pub fn flexpwm0(&mut self) -> Flexpwm0W<'_, MrccGlbAcc0Spec> {
        Flexpwm0W::new(self, 30)
    }
    #[doc = "Bit 31 - FLEXPWM1"]
    #[inline(always)]
    pub fn flexpwm1(&mut self) -> Flexpwm1W<'_, MrccGlbAcc0Spec> {
        Flexpwm1W::new(self, 31)
    }
}
...
#[doc = "`reset()` method sets MRCC_GLB_ACC0 to value 0x8200"]
