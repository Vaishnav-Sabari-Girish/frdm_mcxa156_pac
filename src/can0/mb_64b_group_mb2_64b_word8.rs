...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_35(&mut self) -> DataByte35W<'_, Mb64bGroupMb2_64bWord8Spec> {
        DataByte35W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_34(&mut self) -> DataByte34W<'_, Mb64bGroupMb2_64bWord8Spec> {
        DataByte34W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_33(&mut self) -> DataByte33W<'_, Mb64bGroupMb2_64bWord8Spec> {
        DataByte33W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_32(&mut self) -> DataByte32W<'_, Mb64bGroupMb2_64bWord8Spec> {
