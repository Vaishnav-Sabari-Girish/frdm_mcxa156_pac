...
pub type R = crate::R<Icr5Spec>;
#[doc = "Register `ICR5` writer"]
pub type W = crate::W<Icr5Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr5Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr5Spec> {
        IsfW::new(self, 24)
    }
}
