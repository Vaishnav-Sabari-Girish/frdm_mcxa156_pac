#[doc = "Register `ICR17` reader"]
pub type R = crate::R<Icr17Spec>;
#[doc = "Register `ICR17` writer"]
pub type W = crate::W<Icr17Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr17Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr17Spec> {
        IsfW::new(self, 24)
    }
}
#[doc = "Interrupt Control 17\n\nYou can [`read`](crate::Reg::read) this register and get [`icr17::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr17::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Icr17Spec;
impl crate::RegisterSpec for Icr17Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icr17::R`](R) reader structure"]
impl crate::Readable for Icr17Spec {}
#[doc = "`write(|w| ..)` method takes [`icr17::W`](W) writer structure"]
impl crate::Writable for Icr17Spec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0100_0000;
}
#[doc = "`reset()` method sets ICR17 to value 0"]
impl crate::Resettable for Icr17Spec {}
