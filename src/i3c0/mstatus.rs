...
#[doc = "Field `SLVSTART` reader - Target Start"]
...
#[doc = "Field `SLVSTART` writer - Target Start"]
...
#[doc = "Field `MCTRLDONE` reader - Controller Control Done"]
...
#[doc = "Field `MCTRLDONE` writer - Controller Control Done"]
...
#[doc = "Field `NOWMASTER` reader - Module is now Controller"]
...
#[doc = "Field `NOWMASTER` writer - Module is now Controller"]
...
impl R {
    ...
    #[doc = "Bit 19 - Module is now Controller"]
    #[inline(always)]
