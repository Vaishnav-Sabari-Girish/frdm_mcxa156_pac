...
pub enum FircSclkPeriphEn {
    #[doc = "0: FIRC 48 MHz to peripherals is disabled"]
    Disabled = 0,
    #[doc = "1: FIRC 48 MHz to peripherals is enabled"]
    Enabled = 1,
}
...
#[doc = "Field `FIRC_SCLK_PERIPH_EN` reader - FIRC 48 MHz Clock to peripherals Enable"]
...
#[doc = "Field `FIRC_SCLK_PERIPH_EN` writer - FIRC 48 MHz Clock to peripherals Enable"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Firctren {
    #[doc = "0: Disables trimming FRO_HF by an external clock source"]
    Disabled = 0,
    #[doc = "1: Enables trimming FRO_HF by an external clock source"]
    Enabled = 1,
}
impl From<Firctren> for bool {
    #[inline(always)]
    fn from(variant: Firctren) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FIRCTREN` reader - FRO_HF Trim Enable"]
pub type FirctrenR = crate::BitReader<Firctren>;
impl FirctrenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Firctren {
        match self.bits {
            false => Firctren::Disabled,
            true => Firctren::Enabled,
        }
    }
    #[doc = "Disables trimming FRO_HF by an external clock source"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Firctren::Disabled
    }
    #[doc = "Enables trimming FRO_HF by an external clock source"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == Firctren::Enabled
    }
}
#[doc = "Field `FIRCTREN` writer - FRO_HF Trim Enable"]
pub type FirctrenW<'a, REG> = crate::BitWriter<'a, REG, Firctren>;
impl<'a, REG> FirctrenW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disables trimming FRO_HF by an external clock source"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Firctren::Disabled)
    }
    #[doc = "Enables trimming FRO_HF by an external clock source"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Firctren::Enabled)
    }
}
#[doc = "FIRC Trim Update\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Firctrup {
    #[doc = "0: Disables FIRC trimming updates"]
    Disabled = 0,
    #[doc = "1: Enables FIRC trimming updates"]
    Enabled = 1,
}
impl From<Firctrup> for bool {
    #[inline(always)]
    fn from(variant: Firctrup) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FIRCTRUP` reader - FIRC Trim Update"]
pub type FirctrupR = crate::BitReader<Firctrup>;
impl FirctrupR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Firctrup {
        match self.bits {
            false => Firctrup::Disabled,
            true => Firctrup::Enabled,
        }
    }
    #[doc = "Disables FIRC trimming updates"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Firctrup::Disabled
    }
    #[doc = "Enables FIRC trimming updates"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == Firctrup::Enabled
    }
}
#[doc = "Field `FIRCTRUP` writer - FIRC Trim Update"]
pub type FirctrupW<'a, REG> = crate::BitWriter<'a, REG, Firctrup>;
impl<'a, REG> FirctrupW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disables FIRC trimming updates"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Firctrup::Disabled)
    }
    #[doc = "Enables FIRC trimming updates"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Firctrup::Enabled)
    }
}
#[doc = "FIRC TRIM LOCK\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TrimLock {
    #[doc = "0: FIRC auto trim not locked to target frequency range"]
    FircNotLocked = 0,
    #[doc = "1: FIRC auto trim locked to target frequency range"]
    FircLocked = 1,
}
...
#[doc = "Field `TRIM_LOCK` reader - FIRC TRIM LOCK"]
...
impl TrimLockR {
    ...
    pub const fn variant(&self) -> TrimLock {
        match self.bits {
            false => TrimLock::FircNotLocked,
            true => TrimLock::FircLocked,
        }
    }
    #[doc = "FIRC auto trim not locked to target frequency range"]
    #[inline(always)]
    pub fn is_firc_not_locked(&self) -> bool {
        *self == TrimLock::FircNotLocked
    }
    #[doc = "FIRC auto trim locked to target frequency range"]
    #[inline(always)]
    pub fn is_firc_locked(&self) -> bool {
        *self == TrimLock::FircLocked
    }
}
#[doc = "Coarse Auto Trim Bypass\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CoarseTrimBypass {
    #[doc = "0: FIRC Coarse Auto Trim NOT Bypassed"]
    NotBypassed = 0,
    #[doc = "1: FIRC Coarse Auto Trim Bypassed"]
    Bypassed = 1,
}
...
impl CoarseTrimBypassR {
    ...
    #[doc = "FIRC Coarse Auto Trim NOT Bypassed"]
    #[inline(always)]
    pub fn is_not_bypassed(&self) -> bool {
        *self == CoarseTrimBypass::NotBypassed
    }
    #[doc = "FIRC Coarse Auto Trim Bypassed"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 4 - FIRC 48 MHz Clock to peripherals Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - FRO_HF Trim Enable"]
    #[inline(always)]
    pub fn firctren(&self) -> FirctrenR {
        FirctrenR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - FIRC Trim Update"]
    #[inline(always)]
    pub fn firctrup(&self) -> FirctrupR {
        FirctrupR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - FIRC TRIM LOCK"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 8 - FRO_HF Trim Enable"]
    #[inline(always)]
    pub fn firctren(&mut self) -> FirctrenW<'_, FirccsrSpec> {
        FirctrenW::new(self, 8)
    }
    #[doc = "Bit 9 - FIRC Trim Update"]
    #[inline(always)]
    pub fn firctrup(&mut self) -> FirctrupW<'_, FirccsrSpec> {
        FirctrupW::new(self, 9)
    }
    #[doc = "Bit 11 - Coarse Auto Trim Bypass"]
    #[inline(always)]
    pub fn coarse_trim_bypass(&mut self) -> CoarseTrimBypassW<'_, FirccsrSpec> {
