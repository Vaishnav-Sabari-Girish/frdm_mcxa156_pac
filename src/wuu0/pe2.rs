...
impl From<Reserved21> for u8 {
    #[inline(always)]
    fn from(variant: Reserved21) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Reserved21 {
    type Ux = u8;
}
impl crate::IsEnum for Reserved21 {}
#[doc = "Field `Reserved21` reader - Reserved"]
pub type Reserved21R = crate::FieldReader<Reserved21>;
impl Reserved21R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Reserved21 {
        match self.bits {
            0 => Reserved21::Disable,
            1 => Reserved21::EnRiseHi,
            2 => Reserved21::EnFallLo,
            3 => Reserved21::EnAny,
            _ => unreachable!(),
        }
    }
    ...
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == Reserved21::Disable
    }
    #[doc = "Not supported"]
    #[inline(always)]
    pub fn is_en_rise_hi(&self) -> bool {
        *self == Reserved21::EnRiseHi
    }
    #[doc = "Not supported"]
    #[inline(always)]
    pub fn is_en_fall_lo(&self) -> bool {
        *self == Reserved21::EnFallLo
    }
    #[doc = "Not supported"]
    #[inline(always)]
    pub fn is_en_any(&self) -> bool {
        *self == Reserved21::EnAny
    }
}
#[doc = "Wake-up Pin Enable for WUU_Pn\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl R {
    ...
    pub fn reserved21(&self) -> Reserved21R {
        Reserved21R::new(((self.bits >> 10) & 3) as u8)
    }
