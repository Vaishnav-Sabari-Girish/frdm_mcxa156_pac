...
pub type LdokW<'a, REG> = crate::FieldWriter<'a, REG, 3, Ldok>;
...
pub type CldokW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Run\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Run {
...
pub type RunW<'a, REG> = crate::FieldWriter<'a, REG, 3, Run>;
...
pub type IpolW<'a, REG> = crate::FieldWriter<'a, REG, 3, Ipol>;
...
impl R {
    #[doc = "Bits 0:2 - Load Okay"]
    #[inline(always)]
    pub fn ldok(&self) -> LdokR {
        LdokR::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - Clear Load Okay"]
    #[inline(always)]
    pub fn cldok(&self) -> CldokR {
        CldokR::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bits 8:10 - Run"]
    #[inline(always)]
    pub fn run(&self) -> RunR {
        RunR::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bits 12:14 - Current Polarity"]
    #[inline(always)]
    pub fn ipol(&self) -> IpolR {
        IpolR::new(((self.bits >> 12) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Load Okay"]
