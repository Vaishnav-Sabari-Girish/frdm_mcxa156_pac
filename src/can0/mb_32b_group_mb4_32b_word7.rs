...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_31(&mut self) -> DataByte31W<'_, Mb32bGroupMb4_32bWord7Spec> {
        DataByte31W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_30(&mut self) -> DataByte30W<'_, Mb32bGroupMb4_32bWord7Spec> {
        DataByte30W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_29(&mut self) -> DataByte29W<'_, Mb32bGroupMb4_32bWord7Spec> {
        DataByte29W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_28(&mut self) -> DataByte28W<'_, Mb32bGroupMb4_32bWord7Spec> {
