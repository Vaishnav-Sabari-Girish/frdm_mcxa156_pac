...
impl W {
    ...
    #[inline(always)]
    pub fn ref_scale(&mut self) -> RefScaleW<'_, WriteModeCtrlWSpec> {
        RefScaleW::new(self, 0)
    }
    #[doc = "Bit 8 - Pulse Width Measurement Mode Select"]
    #[inline(always)]
    pub fn pulse_mode(&mut self) -> PulseModeW<'_, WriteModeCtrlWSpec> {
        PulseModeW::new(self, 8)
    }
    #[doc = "Bit 9 - Pulse Polarity"]
    #[inline(always)]
    pub fn pulse_pol(&mut self) -> PulsePolW<'_, WriteModeCtrlWSpec> {
        PulsePolW::new(self, 9)
    }
    #[doc = "Bit 12 - Less Than Minimum Interrupt Enable"]
    #[inline(always)]
    pub fn lt_min_int_en(&mut self) -> LtMinIntEnW<'_, WriteModeCtrlWSpec> {
        LtMinIntEnW::new(self, 12)
    }
    #[doc = "Bit 13 - Greater Than Maximum Interrupt Enable"]
    #[inline(always)]
    pub fn gt_max_int_en(&mut self) -> GtMaxIntEnW<'_, WriteModeCtrlWSpec> {
        GtMaxIntEnW::new(self, 13)
    }
    #[doc = "Bit 14 - Result Ready Interrupt Enable"]
    #[inline(always)]
    pub fn result_ready_int_en(&mut self) -> ResultReadyIntEnW<'_, WriteModeCtrlWSpec> {
        ResultReadyIntEnW::new(self, 14)
    }
    #[doc = "Bit 30 - Continuous Mode Enable"]
    #[inline(always)]
    pub fn continuous_mode_en(&mut self) -> ContinuousModeEnW<'_, WriteModeCtrlWSpec> {
        ContinuousModeEnW::new(self, 30)
    }
    #[doc = "Bit 31 - Measurement In Progress"]
    #[inline(always)]
    pub fn measure_in_progress(&mut self) -> MeasureInProgressW<'_, WriteModeCtrlWSpec> {
