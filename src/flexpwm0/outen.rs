...
pub type PwmxEnW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type PwmbEnW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type PwmaEnW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - PWM_X Output Enables"]
    #[inline(always)]
    pub fn pwmx_en(&self) -> PwmxEnR {
        PwmxEnR::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - PWM_B Output Enables"]
    #[inline(always)]
    pub fn pwmb_en(&self) -> PwmbEnR {
        PwmbEnR::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bits 8:10 - PWM_A Output Enables"]
    #[inline(always)]
    pub fn pwma_en(&self) -> PwmaEnR {
        PwmaEnR::new(((self.bits >> 8) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - PWM_X Output Enables"]
