...
impl W {
    #[doc = "Bits 0:9 - Number of Bytes To Transfer Per Service Request"]
    #[inline(always)]
    pub fn nbytes(&mut self) -> NbytesW<'_, MloffyesTcdNbytesMloffyesSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bits 10:29 - Minor Loop Offset"]
    #[inline(always)]
    pub fn mloff(&mut self) -> MloffW<'_, MloffyesTcdNbytesMloffyesSpec> {
        MloffW::new(self, 10)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn dmloe(&mut self) -> DmloeW<'_, MloffyesTcdNbytesMloffyesSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn smloe(&mut self) -> SmloeW<'_, MloffyesTcdNbytesMloffyesSpec> {
        SmloeW::new(self, 31)
    }
}
