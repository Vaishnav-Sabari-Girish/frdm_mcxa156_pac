...
impl W {
    #[doc = "Bits 0:8 - Current Major Iteration Count"]
    #[inline(always)]
    pub fn citer(&mut self) -> CiterW<'_, ElinkyesTcdCiterElinkyesSpec> {
        CiterW::new(self, 0)
    }
    #[doc = "Bits 9:11 - Minor Loop Link Channel Number"]
    #[inline(always)]
    pub fn linkch(&mut self) -> LinkchW<'_, ElinkyesTcdCiterElinkyesSpec> {
        LinkchW::new(self, 9)
    }
    #[doc = "Bit 15 - Enable Link"]
    #[inline(always)]
    pub fn elink(&mut self) -> ElinkW<'_, ElinkyesTcdCiterElinkyesSpec> {
        ElinkW::new(self, 15)
    }
}
