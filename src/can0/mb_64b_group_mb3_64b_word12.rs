...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_51(&mut self) -> DataByte51W<'_, Mb64bGroupMb3_64bWord12Spec> {
        DataByte51W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_50(&mut self) -> DataByte50W<'_, Mb64bGroupMb3_64bWord12Spec> {
        DataByte50W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_49(&mut self) -> DataByte49W<'_, Mb64bGroupMb3_64bWord12Spec> {
        DataByte49W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_48(&mut self) -> DataByte48W<'_, Mb64bGroupMb3_64bWord12Spec> {
