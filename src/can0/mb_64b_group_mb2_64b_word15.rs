...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_63(&mut self) -> DataByte63W<'_, Mb64bGroupMb2_64bWord15Spec> {
        DataByte63W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_62(&mut self) -> DataByte62W<'_, Mb64bGroupMb2_64bWord15Spec> {
        DataByte62W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_61(&mut self) -> DataByte61W<'_, Mb64bGroupMb2_64bWord15Spec> {
        DataByte61W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_60(&mut self) -> DataByte60W<'_, Mb64bGroupMb2_64bWord15Spec> {
