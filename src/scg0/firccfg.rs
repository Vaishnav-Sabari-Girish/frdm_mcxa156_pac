...
#[repr(u8)]
pub enum FreqSel {
    #[doc = "1: 48 MHz FIRC clock selected, divided from 192 MHz"]
    Firc48mhz192s = 1,
    #[doc = "3: 64 MHz FIRC clock selected"]
    Firc64mhz = 3,
    #[doc = "5: 96 MHz FIRC clock selected"]
    Firc96mhz = 5,
    #[doc = "7: 192 MHz FIRC clock selected"]
    Firc192mhz = 7,
}
