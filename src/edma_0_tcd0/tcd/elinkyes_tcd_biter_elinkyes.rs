...
impl W {
    #[doc = "Bits 0:8 - Starting Major Iteration Count"]
    #[inline(always)]
    pub fn biter(&mut self) -> BiterW<'_, ElinkyesTcdBiterElinkyesSpec> {
        BiterW::new(self, 0)
    }
    #[doc = "Bits 9:11 - Link Channel Number"]
    #[inline(always)]
    pub fn linkch(&mut self) -> LinkchW<'_, ElinkyesTcdBiterElinkyesSpec> {
        LinkchW::new(self, 9)
    }
    #[doc = "Bit 15 - Enable Link"]
    #[inline(always)]
    pub fn elink(&mut self) -> ElinkW<'_, ElinkyesTcdBiterElinkyesSpec> {
        ElinkW::new(self, 15)
    }
}
