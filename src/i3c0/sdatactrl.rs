...
#[doc = "Field `TXCOUNT` reader - Count of Bytes in Transmit"]
pub type TxcountR = crate::FieldReader;
#[doc = "Field `RXCOUNT` reader - Count of Bytes in Receive"]
...
impl R {
    ...
    #[doc = "Bits 16:20 - Count of Bytes in Transmit"]
    #[inline(always)]
    pub fn txcount(&self) -> TxcountR {
        TxcountR::new(((self.bits >> 16) & 0x1f) as u8)
    }
    #[doc = "Bits 24:28 - Count of Bytes in Receive"]
    #[inline(always)]
