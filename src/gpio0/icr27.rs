#[doc = "Register `ICR27` reader"]
pub type R = crate::R<Icr27Spec>;
#[doc = "Register `ICR27` writer"]
pub type W = crate::W<Icr27Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr27Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr27Spec> {
        IsfW::new(self, 24)
    }
}
#[doc = "Interrupt Control 27\n\nYou can [`read`](crate::Reg::read) this register and get [`icr27::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icr27::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Icr27Spec;
impl crate::RegisterSpec for Icr27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icr27::R`](R) reader structure"]
impl crate::Readable for Icr27Spec {}
#[doc = "`write(|w| ..)` method takes [`icr27::W`](W) writer structure"]
impl crate::Writable for Icr27Spec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0100_0000;
}
#[doc = "`reset()` method sets ICR27 to value 0"]
impl crate::Resettable for Icr27Spec {}
