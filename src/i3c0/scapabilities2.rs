...
impl From<I2crst> for bool {
    #[inline(always)]
    fn from(variant: I2crst) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `I2CRST` reader - I2C Software Reset"]
pub type I2crstR = crate::BitReader<I2crst>;
impl I2crstR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> I2crst {
        match self.bits {
            false => I2crst::Disable,
            true => I2crst::Enable,
        }
    }
    #[doc = "Not supported"]
...
impl R {
    ...
    #[doc = "Bit 5 - I2C Software Reset"]
    #[inline(always)]
    pub fn i2crst(&self) -> I2crstR {
        I2crstR::new(((self.bits >> 5) & 1) != 0)
    }
