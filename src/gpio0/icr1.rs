...
pub type R = crate::R<Icr1Spec>;
#[doc = "Register `ICR1` writer"]
pub type W = crate::W<Icr1Spec>;
...
impl W {
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    pub fn irqc(&mut self) -> IrqcW<'_, Icr1Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    pub fn isf(&mut self) -> IsfW<'_, Icr1Spec> {
        IsfW::new(self, 24)
    }
}
